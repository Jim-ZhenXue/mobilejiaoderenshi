  ...
  return (
    <div className="p-3">
      <div className="relative">
        ...
        {showTooltip && (
          <div 
            className="absolute top-full left-1/2 -translate-x-1/2 mt-2 min-w-[500px] p-2 bg-black/80 rounded-lg text-xl text-white text-center whitespace-normal leading-normal hyphens-auto break-words"
          >
