...
export const Instructions: React.FC<InstructionsProps> = ({ level }) => {
  ...
  return (
    <div className="p-3">
      ...
      <p className="text-yellow-400 [&_.animate-gradient]:inline-block [&_.animate-gradient]:bg-gradient-to-r [&_.animate-gradient]:from-pink-500 [&_.animate-gradient]:via-purple-500 [&_.animate-gradient]:to-indigo-500 [&_.animate-gradient]:bg-clip-text [&_.animate-gradient]:text-transparent [&_.animate-gradient]:bg-[length:200%_auto] [&_.animate-gradient]:animate-gradient">
